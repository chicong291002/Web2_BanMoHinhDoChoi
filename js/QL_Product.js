...
const overplay__updateSP = document.querySelector(".overplay_ChinhSuaSP");
...
//Button add san pham
const btn_confirm_add_sp = document.querySelector(".btn_confirm_add_sp");
